...
{
	CFileDialog fdOpenFile(TRUE, _T("mml2mid.exe"), nullptr, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, _T("mml2mid.exe\0mml2mid.exe\0すべてのファイル\0*.*\0\0"));
...
{
	CFileDialog fdOpenFile(TRUE, _T("*.exe;*.cmd;*.bat;*.com"), nullptr, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, _T("プログラム\0*.exe;*.cmd;*.bat;*.com\0すべてのファイル\0*.*\0\0"));
