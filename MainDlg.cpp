...
LRESULT CMainDlg::OnBnClickedBrowsemmlbutton(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/)
{
  ...
  CFileDialog fdOpenFile(TRUE, _T("*.mml"), NULL, OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, _T("MML ファイル (*.mml)\0*.mml\0すべてのファイル\0*.*\0\0"));
...
{
  // TODO : ここにコントロール通知ハンドラ コードを追加します。
  CFileDialog fdOpenFile(FALSE, _T("*.mid"), NULL, OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, _T("標準 MIDI ファイル (*.mid)\0*.mid\0すべてのファイル\0*.*\0\0"));
